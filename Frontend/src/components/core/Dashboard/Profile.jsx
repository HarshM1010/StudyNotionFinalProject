...
const Profile = () => {
  ...
  return (
    <div>
      {
        isClickedEdit ? (
          <div className='flex flex-col pl-7 pt-10 gap-15'>
            <div className='flex flex-col gap-1'>
              <Link to="/dashboard/my-profile" className='hover:text-[#FFE83D] flex flex-row gap-1 items-center text-[#838894] cursor-pointer w-fit' onClick={() => setIsClickedEdit(false)}><IoChevronBack/> Back</Link>
                  ...
                  <div className='pl-25 flex flex-col gap-6'>
                    ...
                    <div className='rounded-xl bg-[#161D29] py-5 flex flex-col gap-7 px-7 w-[60%] border-[#2C333F] border-1'>
                      <div className='w-full flex flex-row items-center justify-between gap-6'>
                        ...
                        <Link to="/dashboard/edit-my-profile" className='flex border flex-row items-center gap-1 bg-[#FFD60A] rounded-md py-1 text-[17px] px-3 text-black cursor-pointer' onClick={() => setIsClickedEdit(true)}><FaRegEdit className='scale-90'/> Edit</Link>
                      </div>
